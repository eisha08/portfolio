...
export const Contact = () => {
  ...
  <div className="w-full max-w-4xl mx-auto bg-gray-800 rounded-lg shadow-lg p-8">
    <div className="text-pink-300 font-bold text-4xl text-center py-8 font-opensans">
      Let's Connect!!
    </div>
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="form-right lg:w-1/2  rounded-xl py-6 px-4 bg-slate-900">
          ...
          <form ref={form} onSubmit={sendEmail} className="space-y-6">
            ...
            <div className="input-container">
              ...
              <input
                type="email"
                name="from_email"
                className="w-full px-4 py-2 bg-gray-700 text-white text-lg rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
              />
            </div>
            <div className="input-container">
